...
const Pt = {
    ...
    Vt = $({
        ...
        setup(s) {
            ...
            return (i, n) => (m(), b("div", Pt, [(m(), b(W, null, _e(t, (l, c) => r("div", {
            ...
            }, null, 4), l.name === "promotion" ? (m(), b("div", Rt)) : C("", !0), r("span", null, p(i.$t(l.name)), 1)], 10, Bt)), 64))]))
        }
    });
const Nt = B(Vt, [
    ["__scopeId", "data-v-48aa04ea"]
]);
...
const Ot = $({
    ...
    setup(s) {
        ...
        function h(v) {
            if (a.value) {
                var g, A = document.getElementById("customerId"),
                    q = A.clientWidth,
                    X = A.clientHeight,
    ...
    Gt = $({
        ...
        setup(s) {
            ...
            return (o, t) => (m(), b("div", {
                ...
                class: F(["dice", [u(a)]])
            }, null, 2), r("p", null, p(u(e) || o.$t("fairAndSafe")), 1), r("img", {
                class: F(["logo", [u(a)]]),
        ...
        setup(s) {
            ...
            return j(() => {
                ...
                return m(), w(N, {
                    ...
                    title: E(() => [r("div", Ut, [r("div", Ft, p(h.$t("firstDialogH")), 1), r("div", jt, p(h.$t("firstDialogTip")), 1)])]),
                    footer: E(() => [r("div", zt, [r("div", {
                        class: F(["active", {
                            a: _.value
                        }]),
                        onClick: H
                    }, p(h.$t("noTipToday")), 3), r("div", {
                        class: "btn",
                        onClick: K
                    }, p(h.$t("activity")), 1)])]),
                    default: E(() => [r("div", Kt, [S(bt, {
                        list: u(n).FirstRechargeList,
                        onGorecharge: V
                    }, null, 8, ["list"])]), r("div", {
                        class: "close",
                        onClick: G
        ...
        setup(s) {
            ...
            return (n, l) => {
                const c = O("van-dialog"),
                    d = pe("lazy");
                return m(), b(W, null, [u(t) ? (m(), w(Wt, {
                    key: 0
                })) : C("", !0), S(c, {
                    show: u(a).showReceiveDialog,
                    "onUpdate:show": l[1] || (l[1] = _ => u(a).showReceiveDialog = _),
                    "show-confirm-button": !1,
                    className: "noOverHidden"
                }, {
                    default: E(() => [r("div", Xt, [r("div", Jt, [L(r("img", null, null, 512), [
                        [d, u(x)("activity/DailyTask", "confirmationReceived")]
                    ]), r("div", Qt, p(n.$t("awardsReceived")), 1), r("div", Zt, [L(r("img", null, null, 512), [
                        [d, u(x)("activity/DailyTask", "amountIcon")]
                    ]), r("span", null, p(u(oe)(u(a).receiveAmount)), 1)]), r("div", {
                        class: "dialog-btn",
                        onClick: l[0] || (l[0] = _ => u(a).showReceiveDialog = !1)
                    }, p(n.$t("confirm")), 1)])])]),
                    _: 1
                }, 8, ["show"]), S(c, {
                    show: u(e).invite,
                    ...
                    default: E(() => [r("div", ea, [r("div", ta, [L(r("img", null, null, 512), [
                        [d, u(x)("activity/DailyTask", "confirmationReceived")]
                    ]), r("div", aa, p(n.$t("inviteTips")), 1), r("p", sa, p(n.$t("inviteAmount")), 1), r("div", oa, [r("span", na, p(n.$t("commissionAmount")), 1), r("span", null, p(u(oe)(u(e).rebateAmount)), 1)]), r("div", {
                        class: "dialog-btn",
                    ...
                    default: E(() => [r("div", ia, [r("div", la, [L(r("img", null, null, 512), [
                        [d, u(x)("activity/DailyTask", "confirmationReceived")]
                    ]), r("p", ra, p(n.$t("oldPromptTip")), 1), r("div", ca, p(n.$t("oldPrompt")), 1), r("p", ua, p(n.$t("oldPromptGift")), 1), r("div", da, [r("span", null, p(u(oe)(u(e).returnAwards)), 1)]), r("div", {
                        class: "dialog-btn",
    ...
    fa = $({
        ...
        setup(s) {
            const a = [{
                ...
                e = ae(),
                o = Object.assign({
                    "/src/views/home/other/blackGoldHome.vue": () => k(() =>
                        import ("./page-home-67e89e9a.js").then(n => n.O), ["assets/js/page-home-67e89e9a.js", "assets/js/modules-aa8ffe67.js", "assets/css/modules-8b01ca49.css", "assets/js/page-activity-6d456111.js", "assets/js/native/index-3d731397.js", "assets/js/en-53bf8069.js", "assets/js/rus-ecb14220.js", "assets/js/vi-60d1c3eb.js", "assets/js/id-16b6cb52.js", "assets/js/hd-c5b1d7e8.js", "assets/js/tha-330057b2.js", "assets/js/md-e8a5e3b0.js", "assets/js/bra-38f5b166.js", "assets/js/my-32fb9d60.js", "assets/js/bdt-d8f19d0c.js", "assets/js/zh-7d334abd.js", "assets/js/pak-dbcb2394.js", "assets/js/ar-78aaffbf.js", "assets/css/page-activity-9da3f4e3.css", "assets/css/page-home-482c7bbf.css"]),
                    "/src/views/home/other/blueHome.vue": () => k(() =>
                        import ("./page-home-67e89e9a.js").then(n => n.P), ["assets/js/page-home-67e89e9a.js", "assets/js/modules-aa8ffe67.js", "assets/css/modules-8b01ca49.css", "assets/js/page-activity-6d456111.js", "assets/js/native/index-3d731397.js", "assets/js/en-53bf8069.js", "assets/js/rus-ecb14220.js", "assets/js/vi-60d1c3eb.js", "assets/js/id-16b6cb52.js", "assets/js/hd-c5b1d7e8.js", "assets/js/tha-330057b2.js", "assets/js/md-e8a5e3b0.js", "assets/js/bra-38f5b166.js", "assets/js/my-32fb9d60.js", "assets/js/bdt-d8f19d0c.js", "assets/js/zh-7d334abd.js", "assets/js/pak-dbcb2394.js", "assets/js/ar-78aaffbf.js", "assets/css/page-activity-9da3f4e3.css", "assets/css/page-home-482c7bbf.css"]),
                    "/src/views/home/other/damanHome.vue": () => k(() =>
                        import ("./page-home-67e89e9a.js").then(n => n.Q), ["assets/js/page-home-67e89e9a.js", "assets/js/modules-aa8ffe67.js", "assets/css/modules-8b01ca49.css", "assets/js/page-activity-6d456111.js", "assets/js/native/index-3d731397.js", "assets/js/en-53bf8069.js", "assets/js/rus-ecb14220.js", "assets/js/vi-60d1c3eb.js", "assets/js/id-16b6cb52.js", "assets/js/hd-c5b1d7e8.js", "assets/js/tha-330057b2.js", "assets/js/md-e8a5e3b0.js", "assets/js/bra-38f5b166.js", "assets/js/my-32fb9d60.js", "assets/js/bdt-d8f19d0c.js", "assets/js/zh-7d334abd.js", "assets/js/pak-dbcb2394.js", "assets/js/ar-78aaffbf.js", "assets/css/page-activity-9da3f4e3.css", "assets/css/page-home-482c7bbf.css"]),
                    "/src/views/home/other/electronic.vue": () => k(() =>
                        import ("./page-home-67e89e9a.js").then(n => n.R), ["assets/js/page-home-67e89e9a.js", "assets/js/modules-aa8ffe67.js", "assets/css/modules-8b01ca49.css", "assets/js/page-activity-6d456111.js", "assets/js/native/index-3d731397.js", "assets/js/en-53bf8069.js", "assets/js/rus-ecb14220.js", "assets/js/vi-60d1c3eb.js", "assets/js/id-16b6cb52.js", "assets/js/hd-c5b1d7e8.js", "assets/js/tha-330057b2.js", "assets/js/md-e8a5e3b0.js", "assets/js/bra-38f5b166.js", "assets/js/my-32fb9d60.js", "assets/js/bdt-d8f19d0c.js", "assets/js/zh-7d334abd.js", "assets/js/pak-dbcb2394.js", "assets/js/ar-78aaffbf.js", "assets/css/page-activity-9da3f4e3.css", "assets/css/page-home-482c7bbf.css"]),
                    "/src/views/home/other/redHome.vue": () => k(() =>
                        import ("./page-home-67e89e9a.js").then(n => n.S), ["assets/js/page-home-67e89e9a.js", "assets/js/modules-aa8ffe67.js", "assets/css/modules-8b01ca49.css", "assets/js/page-activity-6d456111.js", "assets/js/native/index-3d731397.js", "assets/js/en-53bf8069.js", "assets/js/rus-ecb14220.js", "assets/js/vi-60d1c3eb.js", "assets/js/id-16b6cb52.js", "assets/js/hd-c5b1d7e8.js", "assets/js/tha-330057b2.js", "assets/js/md-e8a5e3b0.js", "assets/js/bra-38f5b166.js", "assets/js/my-32fb9d60.js", "assets/js/bdt-d8f19d0c.js", "assets/js/zh-7d334abd.js", "assets/js/pak-dbcb2394.js", "assets/js/ar-78aaffbf.js", "assets/css/page-activity-9da3f4e3.css", "assets/css/page-home-482c7bbf.css"]),
                    "/src/views/home/other/whiteGoldHome.vue": () => k(() =>
            ...
            return (n, l) => {
                ...
                return m(), b("div", va, [S(c, {
                    type: "primary",
                    onClick: l[0] || (l[0] = d => i.value = !i.value)
                }, {
                    default: E(() => [re(p(i.value ? "隐藏" : "展开"), 1)]),
                    _: 1
                }), i.value ? (m(), b("div", pa, [(m(), b(W, null, _e(a, d => S(c, {
                    type: "primary",
                    onClick: _ => t(d.pageName)
                }, {
                    default: E(() => [re(p(d.name), 1)]),
                    _: 2
                }, 1032, ["onClick"])), 64))])) : C("", !0)])
            }
        }
...
const ga = B(fa, [
    ...
    ha = $({
        ...
        setup(s) {
            ...
            const {
                openAll: a
            } = ie(), e = $t(), o = f(!1), t = f(!1), i = se(), n = wt(), l = he(), {
                locale: c
            } = Ie(), d = fe(), _ = f(!1), H = U(() => i.meta.tabBar);
            let G = ["development"];
            ...
            return n.setNumberType(l.getAreacode.substring(1)), J(), j(() => {
                Ct() && Lt(), a(), we(), Q(), N(), localStorage.getItem("language") && Et(localStorage.getItem("language"))
            }), qt(), (I, P) => {
                const Z = O("LoadingView");
                return m(), b(W, null, [S(Z, {
                    loading: D.value,
                    type: "loading",
                    isGame: _.value
                }, {
                    default: E(() => [(m(), w(u(Le), {
                        ...
                        default: E(({
                            ...
                            max: 1
                        }, [u(i).meta.keepAlive ? (m(), w(ce(ee), {
                            key: T.value
                        })) : C("", !0)], 1024)), u(i).meta.keepAlive ? C("", !0) : (m(), w(ce(ee), {
                            key: 0
                        }))]),
                        _: 1
                    })), K.value ? (m(), w(Ot, {
                    ...
                    _: 1
                }, 8, ["loading", "isGame"]), o.value ? (m(), w(Mt, {
                    key: 0
                })) : C("", !0), S(ma), R.value ? (m(), w(ga, {
                    key: 1
                })) : C("", !0)], 64)
            }
        }
        ...
        setup(s, {
            ...
            return j(() => {}), (l, c) => {
                ...
                return m(), b("div", {
                    ...
                    class: F(["navbar-fixed", [s.backgroundColor != "#fff" && "wc"]]),
                    style: ne({
                    ...
                    onClick: i
                }, [Y(l.$slots, "left", {}, () => [s.leftArrow ? (m(), w(d, {
                    key: 0,
                    name: "arrow-left"
                })) : C("", !0)], !0)]), r("div", $a, [s.headLogo ? (m(), b("div", {
                    key: 0,
                    class: "headLogo",
                    style: ne({
                        backgroundImage: "url(" + (s.headerUrl || t.value) + ")"
                    })
                }, null, 4)) : C("", !0), Y(l.$slots, "center", {}, () => [r("div", Ta, p(s.title), 1)], !0)]), r("div", {
                    class: "navbar__content-right",
                    onClick: n
                }, [Y(l.$slots, "right", {}, void 0, !0)])])], 6)], 512)
            }
        }
    });
const Aa = B(Da, [
        ["__scopeId", "data-v-19888208"]
    ]),
    xa = {
    ...
    Ra = Ae('<div class="loading" data-v-4d8a8acc><div class="shape shape-1" data-v-4d8a8acc></div><div class="shape shape-2" data-v-4d8a8acc></div><div class="shape shape-3" data-v-4d8a8acc></div><div class="shape shape-4" data-v-4d8a8acc></div></div>', 1),
    Va = [Ra],
    Na = {
    ...
    qa = $({
        ...
        setup(s) {
            ...
            return j(async () => {
                ...
                return m(), b(W, null, [L(r("div", xa, [Y(t.$slots, "template", {}, () => [L(r("div", Pa, [L(r("div", {
                    ref_key: "element",
                    ref: e,
...
const Oa = B(qa, [
    ...
    Ma = $({
        ...
        setup(s, {
            ...
            return (o, t) => {
                const i = O("van-icon");
                return m(), b("div", Ha, [r("div", {
                    onClick: e
                }, [r("span", Ga, p(s.selectName), 1), S(i, {
                    name: "arrow-down"
                })])])
            }
        }
...
const Ua = B(Ma, [
        ["__scopeId", "data-v-3b481cc4"]
    ]),
    Fa = "whiteGoldHome";
ya(Object.assign({
    "../assets/styles/other/blackGoldHome/reset.scss": () => k(() => Promise.resolve({}), ["assets/css/reset-8972b5eb.css"]),
    "../assets/styles/other/blueHome/reset.scss": () => k(() => Promise.resolve({}), ["assets/css/reset-58948e2b.css"]),
    "../assets/styles/other/damanHome/reset.scss": () => k(() => Promise.resolve({}), ["assets/css/reset-b438533a.css"]),
    "../assets/styles/other/electronic/reset.scss": () => k(() => Promise.resolve({}), ["assets/css/reset-7c75dfed.css"]),
    "../assets/styles/other/redHome/reset.scss": () => k(() => Promise.resolve({}), ["assets/css/reset-b72ca269.css"]),
    "../assets/styles/other/whiteGoldHome/reset.scss": () => k(() => Promise.resolve({}), ["assets/css/reset-910da13b.css"])
}), `../assets/styles/other/${Fa}/reset.scss`);
const ja = s => {
    s.component("NavBar", Aa), s.component("LoadingView", Oa), s.component("ArSelect", Ua), s.component("svg-icon", xt), s.use(xe).use(Pe).use(Be).use(Re).use(Ve).use(Ne).use(qe).use(Oe).use(He).use(Ge).use(Me).use(Ue).use(Fe).use(je).use(Ke).use(ze).use(Ye).use(We).use(Xe).use(Je).use(Qe).use(Ze).use(et).use(tt).use(at).use(st).use(ot).use(nt).use(it).use(lt).use(rt).use(ct).use(ut).use(dt).use(_t).use(mt).use(vt).use(ye).use(La).use(pt);
...
const y = Ka(),
    za = {
        "91club": () => {
            ...
            const o = y.fb_dynamic_pixel || localStorage.getItem("fb_dynamic_pixel") || s[a];
