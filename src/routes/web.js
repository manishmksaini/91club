...
import jiliGamesController, { GAME_CATEGORIES_MAP } from "../controllers/jiliGamesController.js"
...
const initWebRouter = app => {
   ...
   router.get("/jili/game_link", middlewareController, jiliGamesController.getGameLink)
   router.get("/jili/slots", middlewareController, jiliGamesController.gameCategoriesPage(GAME_CATEGORIES_MAP.SLOT))
   router.get("/jili/fishing", middlewareController, jiliGamesController.gameCategoriesPage(GAME_CATEGORIES_MAP.FISHING))
   router.get("/jili/jili/minigames", middlewareController, jiliGamesController.gameCategoriesPage(GAME_CATEGORIES_MAP.MINIGAMES))
   router.get("/jili/casino", middlewareController, jiliGamesController.gameCategoriesPage(GAME_CATEGORIES_MAP.CASINO))
   router.get("/jili/poker", middlewareController, jiliGamesController.gameCategoriesPage(GAME_CATEGORIES_MAP.POKER))
